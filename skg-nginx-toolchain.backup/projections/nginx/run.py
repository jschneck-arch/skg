#!/usr/bin/env python3
"""
projections/nginx/run.py
============================
Auto-generated projection engine for the Nginx toolchain.
Same substrate logic as all SKG projectors: tri-state, score, classify.

Generated by skg.forge at 2026-03-14T23:24:22.405672+00:00
"""
...
SOURCE_ID  = "projection.nginx"
SCORE_KEY  = "nginx_score"
...
def compute_nginx(events, catalog: dict, attack_path_id: str,
...
def main():
    p = argparse.ArgumentParser(description="Nginx projection engine")
    ...
    result = compute_nginx(events, catalog, a.attack_path_id,
