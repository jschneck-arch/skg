#!/usr/bin/env python3
"""
projections/iot_firmware/run.py
================================
Projection engine for the IoT firmware toolchain.
...
SOURCE_ID = "projection.iot_firmware"
...
def compute_iot_score(
    ...
    return {
        "id":   str(uuid.uuid4()),
        "ts":   iso_now(),
        "type": "interp.iot_firmware.realizability",
        "source": {
...
def main():
    p = argparse.ArgumentParser(description="IoT firmware projection engine")
