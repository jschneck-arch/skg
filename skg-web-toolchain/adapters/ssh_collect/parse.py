#!/usr/bin/env python3
"""
adapter: web_collect  [LEGACY — NOT ACTIVE]
Auto-generated by skg.forge for Apache/APR-specific SSH collection.
Generated: 2026-03-16T19:34:20.923368+00:00

WARNING: This file uses the legacy W-01..W-05 wicket vocabulary which predates
the current WB-* web catalog schema.  It is NOT called by the active web
projector and is NOT referenced from any live runtime path.  Do not patch or
extend this file as if it were canonical — it is retained only as a historical
artifact.  Any live Apache web collection should use the WB-* IDs defined in
attack_preconditions_catalog.web.v1.json.
"""
import json, uuid, re
